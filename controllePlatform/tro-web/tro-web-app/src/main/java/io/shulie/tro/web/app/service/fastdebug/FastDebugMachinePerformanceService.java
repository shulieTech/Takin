 ...
 * @Description:
 */
public interface FastDebugMachinePerformanceService {

    List<FastDebugMachinePerformanceResponse> getMachinePerformance(String traceId, String rpcId, Integer logType);
