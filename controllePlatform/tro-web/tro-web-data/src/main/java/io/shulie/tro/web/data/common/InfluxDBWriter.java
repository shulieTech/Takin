...
package io.shulie.tro.web.data.common;
...
public class InfluxDBWriter {
    private static Logger logger = LoggerFactory.getLogger(InfluxDBWriter.class);
    ...
    public void writeBatchPoint(List<Point> points) {
        getInfluxDB().write(BatchPoints.database(database).points(points).build());
    }
    ...
    public void createDB(String dbName) {
        getInfluxDB().setDatabase(dbName);
    }
    ...
    public void createRetentionPolicy() {
        ...
        getInfluxDB().query(new Query(command, database));
    }
