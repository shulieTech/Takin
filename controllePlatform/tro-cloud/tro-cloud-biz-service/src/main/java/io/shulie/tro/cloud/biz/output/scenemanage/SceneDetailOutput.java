...
import io.shulie.tro.cloud.data.result.scenemanage.BusinessActivityDetailResult;
import io.shulie.tro.cloud.data.result.scenemanage.ScriptDetailResult;
import io.shulie.tro.cloud.data.result.scenemanage.SlaDetailResult;
 ...
 */
@Data
public class SceneDetailOutput implements Serializable {
