...
public class LicenceUtils {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> dataMap = analysisLicense(
            "fwqzIRVAsV5WWUhyXFGsVA44RFEBNy6jmE+0IbyNGxn7Zm7SvwCNBIRhtagj+nQ6IOyn2iCPsC0xkv0ksjJEGUzNA3PDXGbwLXw"
                + "+32orme2367IBsBY2mHaygIucWGaw");
