 ...
 */
public class ShardFlushRequestIndexRename extends AbstractReadRequestIndexRename {
    @Override
    ...
    public List<String> reindex0(Object target) {
        ShardFlushRequest req = (ShardFlushRequest) target;
    ...
    public List<String> getIndex0(Object target) {
        ShardFlushRequest req = (ShardFlushRequest) target;
        return (req.index() == null) ? Collections.EMPTY_LIST : Arrays.asList(req.index());
    }
}
