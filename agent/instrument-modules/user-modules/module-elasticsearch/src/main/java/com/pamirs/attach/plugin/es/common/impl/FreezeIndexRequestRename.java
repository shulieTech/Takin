 ...
 */
public class FreezeIndexRequestRename extends AbstractWriteRequestIndexRename {
    @Override
    ...
    public List<String> reindex0(Object target) {
        FreezeIndexRequest req = (FreezeIndexRequest) target;
        String[] indexes = req.getIndices();
