 ...
 */
public class GetIndexRequestIndex1Rename extends AbstractReadRequestIndexRename {
    @Override
    ...
    public List<String> reindex0(Object target) {
        GetIndexRequest req = (GetIndexRequest) target;
        ...
        Reflect.on(req).set("indices", indices);
