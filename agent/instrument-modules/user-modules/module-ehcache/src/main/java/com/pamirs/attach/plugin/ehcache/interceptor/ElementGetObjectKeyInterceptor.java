 ...
 * @since 2021/3/2 5:10 下午
 */
public class ElementGetObjectKeyInterceptor extends ResultInterceptorAdaptor {
    @Override
    protected Object getResult0(Advice advice) {
        Object result = advice.getReturnObj();
        if (result instanceof ClusterTestCacheWrapperKey) {
            return ((ClusterTestCacheWrapperKey) result).getKey();
        }
        return result;
    }
}
