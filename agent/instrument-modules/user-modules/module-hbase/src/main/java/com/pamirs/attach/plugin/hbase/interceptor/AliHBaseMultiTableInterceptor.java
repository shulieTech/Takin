 ...
 */
public class AliHBaseMultiTableInterceptor extends TraceInterceptorAdaptor {
    @Override
    ...
    public SpanRecord beforeTrace(Advice advice) {
        AliHBaseMultiTable hTable = (AliHBaseMultiTable) advice.getTarget();
    ...
    private String getTableName(AliHBaseMultiTable target) {
