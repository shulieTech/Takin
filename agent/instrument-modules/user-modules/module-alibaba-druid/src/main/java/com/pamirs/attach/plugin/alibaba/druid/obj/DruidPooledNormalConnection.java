...
import com.pamirs.attach.plugin.common.datasource.normal.NormalPreparedStatement;
import com.pamirs.attach.plugin.common.datasource.normal.NormalStatment;
...
/**
 * Create by xuyh at 2020/3/22 14:59.
 */
public class DruidPooledNormalConnection extends DruidPooledConnection {
    ...
    public String getSchema() throws SQLException {
        ...
        for (Map.Entry<String, ShadowDatabaseConfig> entry : GlobalConfig.getInstance().getShadowDatasourceConfigs().entrySet()) {
            ...
            if (schema.equalsIgnoreCase(schemaOriginal)) {
    ...
    public CallableStatement prepareCall(String arg0) throws SQLException {
        ...
        return new CheckedTraceCallableStatement(target.prepareCall(arg0), arg0, this.url, this.username, this.dbType, false, false, sqlMetaData);
    }
    ...
    public CallableStatement prepareCall(String arg0, int arg1, int arg2)
        ...
        return new CheckedTraceCallableStatement(target.prepareCall(arg0, arg1, arg2), arg0, this.url, this.username, this.dbType, false, false, sqlMetaData);
    }
    ...
    public CallableStatement prepareCall(String arg0, int arg1, int arg2,
        ...
        return new CheckedTraceCallableStatement(target.prepareCall(arg0, arg1, arg2, arg3), arg0, this.url, this.username, this.dbType, false, false, sqlMetaData);
    }
