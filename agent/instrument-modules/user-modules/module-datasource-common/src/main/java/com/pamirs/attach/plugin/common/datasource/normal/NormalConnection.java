...
import com.pamirs.attach.plugin.common.datasource.check.NormalCheckPreparedStatement;
import com.pamirs.attach.plugin.common.datasource.check.NormalCheckStatement;
...
public class NormalConnection implements Connection {
    ...
    public CallableStatement prepareCall(String arg0) throws SQLException {
        if (Pradar.isClusterTest()) {
            throw new SQLException("PT test not support CallableStatement Procedure & Function : " + arg0);
        }
        return new CheckedTraceCallableStatement(connection.prepareCall(arg0), arg0, this.url, this.username, this.dbType, false, false, sqlMetaData);

//        arg0=ShemaReplacer.replaceTable(arg0, this.connection, this.dbConnectionKey,this.dbType);
//        return new NormalCallableStatment(connection.prepareCall(arg0),this.connection, this.dbConnectionKey, this.dbType);
    }
    ...
    public CallableStatement prepareCall(String arg0, int arg1, int arg2)
            throws SQLException {
        if (Pradar.isClusterTest()) {
            throw new SQLException("PT test not support CallableStatment Producre & Function : " + arg0);
        }
        return new CheckedTraceCallableStatement(connection.prepareCall(arg0, arg1, arg2), arg0, this.url, this.username, this.dbType, false, false, sqlMetaData);

//        arg0=ShemaReplacer.replaceTable(arg0, this.connection, this.dbConnectionKey,this.dbType);
//        return new NormalCallableStatment(connection.prepareCall(arg0,arg1,arg2),this.connection, this.dbConnectionKey, this.dbType);
    }
    ...
    public CallableStatement prepareCall(String arg0, int arg1, int arg2,
        ...
        return new CheckedTraceCallableStatement(connection.prepareCall(arg0, arg1, arg2, arg3), arg0, this.url, this.username, this.dbType, false, false, sqlMetaData);
    }
