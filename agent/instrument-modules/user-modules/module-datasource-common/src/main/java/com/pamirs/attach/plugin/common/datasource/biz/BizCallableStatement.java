...
/**
 * @author xiaobin.zfb
 * @since 2020/9/11 11:53 上午
 */
public class BizCallableStatement extends BizPreparedStatement implements CallableStatement {
    private CallableStatement statement;

    public BizCallableStatement(CallableStatement target) {
        super(target);
