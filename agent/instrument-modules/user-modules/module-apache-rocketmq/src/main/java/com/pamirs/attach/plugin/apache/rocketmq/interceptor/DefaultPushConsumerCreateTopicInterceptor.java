        ...
        if (args.length == 3) {
            ...
            if (consumer != null) {
                try {
                    ...
                    logger.error("Apache-RocketMQ: create topic err, key: {} newTopic:{},queueNum:{}", args[0], args[1], args[2], e);
            ...
            if (consumer != null) {
                try {
                    ...
                    logger.error("Apache-RocketMQ: create topic err, key: {} newTopic: {}, queueNum: {}, topicSysFlag: {}", args[0], args[1], args[2], args[3], e);
                    throw new PressureMeasureError(e);
                }
            }
        }
