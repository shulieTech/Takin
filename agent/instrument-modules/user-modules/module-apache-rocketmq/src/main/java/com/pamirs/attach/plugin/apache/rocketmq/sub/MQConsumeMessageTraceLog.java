 ...
 */
package com.pamirs.attach.plugin.apache.rocketmq.sub;
...
public class MQConsumeMessageTraceLog {
    ...
    private static void recordSingleMsgBeforeConsume(MQTraceContext ctx, MQTraceBean traceBean, String firstTrace) {
        ...
        String serviceName = PradarLogUtils.getService(traceBean);
        String methodName = ctx.getGroup();

        Pradar.startServerInvoke(serviceName, methodName, traceBean.getContext());
