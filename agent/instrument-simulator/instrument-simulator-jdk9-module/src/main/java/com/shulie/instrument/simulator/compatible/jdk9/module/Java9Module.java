...
import com.shulie.instrument.simulator.compatible.jdk9.exception.ModuleException;
import com.shulie.instrument.simulator.compatible.jdk9.util.RedefineModuleUtils;
import com.shulie.instrument.simulator.compatible.module.JavaModule;
import com.shulie.instrument.simulator.compatible.module.Providers;
...
public class Java9Module implements JavaModule {
    ...
    @Override
    public void addAllExports(JavaModule target) {
        Set<String> packages = getPackages();
        for (String packageName : packages) {
            addExports(packageName, target);
        }
    }
